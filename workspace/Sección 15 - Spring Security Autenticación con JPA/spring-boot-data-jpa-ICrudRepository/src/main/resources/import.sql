/* Archivo de pruebas */
/*NOTA: Como estamos trabajando con una base de datos H2 en desarrollo para las pruebas, es importante que creemos este archivo dentro de resources y lo llamemos import.sql*/
/* Populate tables*/
