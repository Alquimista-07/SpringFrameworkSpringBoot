...
public class Factura {
    ...
    */
	...
	/*
	 * NOTA: Inyectamos el listado de los items, y como tenemos un solo componente, una sola implementación,
	 *       un solo método, lo podemos inyectar de forma directa, pero si tuviermos más de una podríamos 
	 *       hacer la inyección usando la anotación @Primary o bien con el @Qualifier y el nombre del Bean
	 */
	@Autowired
